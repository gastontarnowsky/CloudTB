...
export const Footer = () => {
    ...
    return (
        <footer className="footer items-center justify-center md:justify-between p-4 bg-neutral text-neutral-content py-16 w-full">

            <div className="items-center grid-flow-col pl-0 md:pl-5 mx-auto">
            ...
            <div className="grid-flow-col gap-4 md:place-self-center md:justify-self-end sm:mr-10">
                <a href="#presentacion" className="text-zinc-400 text-lg px-3 py-1 border border-transparent hover:border-gray-400 rounded-xl">
                    Innovados
                </a>
