    ...
    return (
        <section className={`h-screen block relative w-full`}  id="presentacion">  
            <div className={'h-screen relative z-20 w-11/12 md:w-9/12 mx-auto'}>
                <div className='h-full flex flex-col justify-center items-start mb-10 lg:my-0'>
                    <span className='font-bold tracking-wider text-xl text-rojo'>Bienvenida Innovación</span>
                    <div className='mt-2 py-4 rounded-lg '>
                        <h1 className='font-black text-5xl sm:text-7xl md:text-8xl uppercase text-azulOscuro'>INNOVADOS</h1>
                    </div>
