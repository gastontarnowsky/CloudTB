  ...
  return (
    <div className="text-5xl text-center" id="sobrenosotros">
        ...
        <div className="pt-20 px-5 md:px-10 bg-gray-200">
            <h2 className="text-gray-500 font-rajdhani  font-semibold text-3xl md:text-4xl px-0 md:px-20 xl:px-80 py-0 pt-10 lg:py-20  ">
                No nos gusta definirnos por <span className="text-azulOscuro">lo que hemos hecho</span>, sino por <span className="text-azulOscuro">lo que queremos ofrecer</span>.
            </h2>
        </div>
        ...
        <div className="w-full flex justify-center bg-gray-200 pt-20">
            <p className="font-rajdhani border-2 border-b-azulOscuro">DESARROLLO DE SOFTWARE</p>
        </div>
        <div className="px-3 sm:px-10 xl:px-32 pt-20 bg-gray-200 lg:flex justify-between">
            ...
            <div className=" mt-10 lg:mt-0 font-normal order-first xl:mr-5 xl:mt-10">
                <p className="font-rajdhani text-azulOscuro text-4xl px-0 md:px-20 xl:px-2">
        ...
        <div className=" bg-gray-200 pt-20 font-thin">
            <p className="font-rajdhani tracking-[1px] text-5xl text-azulOscuro">Tecnología que revoluciona el mercado</p>
                    ...
                    {cardsPresent.map((card) => (
                        <SwiperSlide key={card.title}>
                            ...
                            <div className=" bg-white mb-10 pt-10 pb-15 px-5 rounded-xl shadow-lg shadow-neutral-500 h-auto">
                                ...
                                <p className="pb-16 md:pb-0 md:h-[350px] lg:h-[450px] xl:h-72 text-lg font-normal text-gray-700
                                    px-4"> 
                                    {card.text}
                                </p>
                            </div>
