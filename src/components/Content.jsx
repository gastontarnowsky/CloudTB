  ...
  return (
    <section className="w-full pt-10 align-center bg-white text-black absolute">
        ...
        <div className="w-[90%] sm:w-[60%] mx-auto">
            <h3 className="text-center text-2xl p-2 mt-2 mb-10 font-rajdhani">Somos una empresa creadora de software, con más de tres años de experiencia y con una amplia gama  de disciplinas de diseño.</h3>
        </div>

        {/*** Primera imagen ***/}
        <div className="w-[50%] md:w-[35%] xl:w-[30%] bg-azul rounded-full mx-auto z-10 absolute right-0 md:top-96 left-0">
            <img src="company.svg" alt="Image company" className="rounded-full pb-14" />
        </div>

        
        <div className="block pt-20 md:pt-0 lg:pt-20 pb-10 bg-gradient-to-t from-azul to-white lg:justify-between lg:align-center ">
